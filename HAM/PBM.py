...
class thermoPBM(torch.nn.Module):
    ...
    def calculate_U(self, T_ext, Q_sunExt=torch.zeros(13), Q_sunPen=torch.zeros(13), Q_ir=torch.zeros(13),
                    Ww=0.5, Lr=torch.zeros(13), Wr=0.5, Lc=torch.zeros(13), H=torch.zeros(13), C=torch.zeros(13)):
